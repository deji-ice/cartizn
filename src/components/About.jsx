...
const About = () => {
    return <section className="relative text-[#F5F5F5] flex font-thin h-[18rem]">
        <div className="flex-4 p-10  flex flex-col gap-3 items-center justify-center cursor-pointer ">
        ...
        <div className="text-[13px] flex flex-1 flex-col pr-[10.9rem] pl-10 justify-start pt-5 leading-7">
            <p className="mb-3">
                Hello, i'm <br />
